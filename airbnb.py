...
st.set_page_config(page_title="AirBnb-Analysis by ELANGO S!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\sri\Desktop\Nairbnb")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"ELANGO S"}')
    mail = (f'{"Mail :"}  {"elangoselva7@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/Elangoselva",
        "LINKEDIN": "https://www.linkedin.com/in/elango-selvaraju-548b87156"}
